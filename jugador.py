...
class Jugador(Persona):
    ...
    def mostrarPersona(self):
        return  f"{super().mostrarPersona()}, juega en {self.equipo} como {self.posicion}. Goles: {self.goles}"
    ...
    def mostrar_elementos(cls):
        respuesta = super().mostrar_elementos()
        if(respuesta ==1):
            ...
            try:    
                ...
                for jugador in jugadores:
                    ...
                    total += jugador_obj.mostrarPersona() + "\n"
                return total
            ...
            return "No es posible hacer eso ahora"